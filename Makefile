...
lint-py:  ## run python linter with ruff
	python -m ruff check zarc
	python -m ruff format --check zarc
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix zarc
	python -m ruff format zarc
...
test-py:  ## run python tests
	python -m pytest -v zarc/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v zarc/tests --cov=zarc --cov-report term-missing --cov-report xml
